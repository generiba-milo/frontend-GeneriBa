...
import { Shield, Wallet, Users, Zap, AlertCircle } from 'lucide-react';
const Login = () => {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2 animate-fade-in">
          ...
          <h1 className="font-display text-3xl font-bold">Welcome to GeneriBa</h1>
          <p className="text-muted-foreground">
            Fair work. Open future. DAO-powered gigs.
          </p>
        </div>
        {}
        <Card className="p-8 border-border bg-card/50 backdrop-blur-sm animate-fade-in-up" style={{ animationDelay: '100ms' }}>
          <div className="space-y-6">
            <div className="space-y-4">
              <h2 className="text-2xl font-semibold text-center">Sign In</h2>
              <p className="text-sm text-muted-foreground text-center">
                Connect with Google to access your dashboard
              </p>
            </div>
            {}
            {(loginError || error) && (
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">Why GeneriBa?</span>
              </div>
            </div>
            {}
            <div className="space-y-3 pt-2">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  <p className="font-medium">KYC-Free & Decentralized</p>
                  <p className="text-muted-foreground text-xs">
                    Work globally without identity verification
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground text-xs">
                    Community-driven decisions and rewards
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground text-xs">
                    On-chain trust scores and verified skills
                  </p>
                </div>
              </div>
            </div>
        ...
        {}
        <div className="text-center text-sm text-muted-foreground animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          <p>
