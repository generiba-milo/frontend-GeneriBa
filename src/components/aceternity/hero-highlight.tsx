...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex min-h-[500px] w-full items-center justify-center bg-white dark:bg-black",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-md bg-gradient-to-r from-indigo-300 to-purple-300 px-2 py-0.5 dark:from-indigo-500 dark:to-purple-500 text-sm md:text-base shadow-lg shadow-purple-500/50 animate-pulse`,
        className,
      )}
    >
      ...
      <motion.span
        className="absolute inset-0 rounded-md bg-gradient-to-r from-transparent via-white/40 to-transparent"
        animate={{
          x: ["-200%", "200%"],
        }}
        transition={{
